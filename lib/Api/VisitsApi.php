...
class VisitsApi
{
    ...
    {
        $this->createVisitWithHttpInfo($candid, $visit, $visit_create_request, $contentType);
    }
    ...
    /**
     * Create request for operation 'createVisit'
     *
     * @param  string $candid (required)
     * @param  string $visit (required)
     * @param  \LORISClient\Model\VisitCreateRequest $visit_create_request (required)
    ...
    public function createVisitRequest($candid, $visit, $visit_create_request, string $contentType = self::contentTypes['createVisit'][0])
    {
        ...
        if ($candid === null || (is_array($candid) && count($candid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $candid when calling createVisit'
            );
        }
        ...
        if ($visit === null || (is_array($visit) && count($visit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $visit when calling createVisit'
            );
        }
        ...
        $resourcePath = '/candidates/{candid}/{visit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getVisit($candid, $visit, string $contentType = self::contentTypes['getVisit'][0])
    {
        list($response) = $this->getVisitWithHttpInfo($candid, $visit, $contentType);
        return $response;
    }
     ...
     */
    public function getVisitWithHttpInfo($candid, $visit, string $contentType = self::contentTypes['getVisit'][0])
    {
        $request = $this->getVisitRequest($candid, $visit, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVisitAsync($candid, $visit, string $contentType = self::contentTypes['getVisit'][0])
    {
        return $this->getVisitAsyncWithHttpInfo($candid, $visit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVisitAsyncWithHttpInfo($candid, $visit, string $contentType = self::contentTypes['getVisit'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVisitRequest($candid, $visit, string $contentType = self::contentTypes['getVisit'][0])
    {
        ...
        if ($visit === null || (is_array($visit) && count($visit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $visit when calling getVisit'
            );
        }
