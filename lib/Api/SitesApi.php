...
class SitesApi
{
     ...
     * @return \LORISClient\Model\SitesResponse
     */
     ...
     * @throws \LORISClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LORISClient\Model\SitesResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\LORISClient\Model\SitesResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\LORISClient\Model\SitesResponse';
        $request = $this->getSitesRequest($contentType);
