 ...
 */
class VisitCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VisitCreate';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['candID'] === null) {
            $invalidProperties[] = "'candID' can't be null";
        }
        if ($this->container['visit'] === null) {
            $invalidProperties[] = "'visit' can't be null";
        }
