...
class CandidateCreateRequestCandidate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CandidateCreateRequestCandidate';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('edc', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['edc'];
    }

    /**
     * Sets edc
     *
     * @param string|null $edc edc
     *
     * @return self
     */
    ...
    {
        if (is_null($edc)) {
            throw new \InvalidArgumentException('non-nullable edc cannot be null');
        }
        $this->container['edc'] = $edc;
