 ...
 */
class IdMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdMapping';
    ...
    */
     ...
     * Sets extStudyID
     *
     * @param string|null $extStudyID External study ID (PSCID)
     *
     * @return self
     */
     ...
     * Sets candID
     *
     * @param string|null $candID LORIS candidate ID
     *
     * @return self
     */
